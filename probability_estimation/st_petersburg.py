...
for flips in flips_arr:
    money_arr.append(2**flips)
...
print(f"Average flips until tails: {sum(flips_arr) / len(flips_arr)}")
print(f"Avg money made: {sum(money_arr) / len(money_arr):,.2f}")
